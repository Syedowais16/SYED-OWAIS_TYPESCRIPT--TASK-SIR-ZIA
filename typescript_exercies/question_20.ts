...
for (let index = 0; index < rivers.length; index++) //if we have one line logic for any loop or condition we did not require curly brackets
      console.log(rivers[index]);
